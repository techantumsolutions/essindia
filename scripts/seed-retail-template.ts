  ...
  const sectionsData = [
    {
      ...
      contentJson: {
        bgColor: '#f3f5ff',
        badgeBgColor: '#61459a',
        badgeText: 'Retail Solutions',
        badgeTextColor: '#ffffff',
        title: 'Unify Your Retail Operations & POS Systems',
        titleColor: '#8873b3',
        description: 'Integrate billing, stock, inventory, and analytics in real time across all brick-and-mortar storefronts.',
        descriptionColor: '#818183',
        buttonText: 'Book Free Demo',
        buttonUrl: '/demo',
        buttonBgColor: '#fbbf24',
        buttonTextColor: '#472393',
