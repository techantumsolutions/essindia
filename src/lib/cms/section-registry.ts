...
export const SECTION_REGISTRY: SectionTypeDefinition[] = [
  ...
  },
  {
    type: 'ass-stats',
    label: 'ASS Stats',
    description: 'Stats section with image and metrics',
    icon: FileText,
    color: 'bg-cyan-50 text-cyan-600',
    defaultVariant: 'default',
    supportsVariants: false,
    fieldOrder: ['image', 'badgeText', 'title', 'description', 'stats'],
  },
  {
    type: 'ass-process',
    label: 'ASS Process',
  ...
  {
    type: 'ass-why-choose',
    label: 'ASS Why Choose',
    description: 'Dark-themed why-choose grid',
    icon: MousePointer,
  ...
  },
  {
    ...
    label: 'ASS Features Grid',
    description: 'Detailed feature cards grid',
    icon: Grid,
    color: 'bg-blue-50 text-blue-600',
    defaultVariant: 'default',
    supportsVariants: false,
    fieldOrder: ['title', 'features'],
  },
  {
    type: 'ass-cta',
    label: 'ASS CTA',
