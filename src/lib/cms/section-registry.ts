...
export const SECTION_REGISTRY: SectionTypeDefinition[] = [
  ...
  },
  {
    ...
    type: 'AboutUsHero',
    label: 'About Us Hero',
    description: 'Dark gradient hero section with statistics',
    icon: Layout,
    color: 'bg-indigo-50 text-indigo-600',
    type: 'quality-hero',
  ...
  },
  {
    ...
    label: 'About Us Company Intro',
    description: 'Two-column text and highlights with image',
    icon: Type,
    color: 'bg-slate-50 text-slate-600',
    defaultVariant: 'default',
    supportsVariants: false,
  },
  {
    ...
    description: 'Mission and Vision cards with illustrations',
    icon: Layers,
    color: 'bg-blue-50 text-blue-600',
    defaultVariant: 'default',
    supportsVariants: false,
  },
  {
    ...
    label: 'About Us Services Overview',
    description: 'Three services overview cards',
    icon: Briefcase,
    color: 'bg-emerald-50 text-emerald-600',
    defaultVariant: 'default',
    supportsVariants: false,
  },
  {
    ...
    label: 'About Us Transformation',
    description: 'Legacy migration and upgrade grid',
    icon: Grid,
    color: 'bg-purple-50 text-purple-600',
    defaultVariant: 'default',
    supportsVariants: false,
  ...
  {
    type: 'AboutUsWhyEss',
    label: 'About Us Why ESS',
    description: 'Six trust points grid',
    icon: MousePointer,
  ...
  },
  {
    ...
    type: 'AboutUsCta',
    label: 'About Us CTA',
    description: 'Schedule demo contact block',
    icon: Layout,
    color: 'bg-rose-50 text-rose-600',
    defaultVariant: 'default',
    supportsVariants: false,
