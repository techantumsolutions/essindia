...
export const SECTION_REGISTRY: SectionTypeDefinition[] = [
  ...
  {
    type: 'mfg-icons',
    label: 'Manufacturing Icons',
    description: 'Icon row for manufacturing',
    icon: Grid,
    color: 'bg-slate-50 text-slate-600',
    defaultVariant: 'default',
    supportsVariants: false,
  },
  {
    ...
    description: 'Text block for connecting demand',
    icon: Type,
    color: 'bg-emerald-50 text-emerald-600',
    defaultVariant: 'default',
    supportsVariants: false,
  },
  {
    ...
    description: 'Process workflow circles',
    icon: Layers,
    color: 'bg-blue-50 text-blue-600',
    defaultVariant: 'default',
    supportsVariants: false,
  },
  {
    ...
    description: 'Dashboard showcase section',
    icon: Layout,
    color: 'bg-purple-50 text-purple-600',
    defaultVariant: 'default',
    supportsVariants: false,
  ...
  {
    type: 'mfg-models',
    label: 'Manufacturing Models',
    description: 'Grid of operating models',
    icon: Grid,
    color: 'bg-amber-50 text-amber-600',
    defaultVariant: 'default',
    supportsVariants: false,
