        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <div className="pt-4 border-t border-slate-100 flex items-center gap-3 w-full">
              ...
              <Link href={getStartedLink} onClick={() => setIsMobileMenuOpen(false)} className="flex-1 w-full min-w-0 block">
                <Button className="w-full bg-[#111] hover:bg-black text-white rounded-none py-2 px-3 text-xs sm:text-sm transition-all duration-300 hover:shadow-xl font-medium truncate">
                  {getStartedText}
                </Button>
              </Link>
            </div>
