...
export function BiHero({ content }: { content?: BiHeroContent }) {
  ...
  return (
    <section
      className="pt-40 pb-14 px-6 relative overflow-hidden flex items-center min-h-[660px] text-slate-800"
      style={bgStyles}
    >
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl lg:text-[56px] font-light tracking-tight leading-[1.15] font-sans whitespace-pre-line"
            ...
            >
              {button1Text && (
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                  <Link
                    href={button1Url}
                    className="inline-block px-8 py-3.5 rounded-full text-sm font-bold shadow-md transition-all border text-center"
                    style={{
