...
export function ErpIntro({ content }: ErpIntroProps) {
  ...
  return (
    <section className="relative w-full py-20 bg-[#F8F9FA] overflow-hidden border-b border-slate-100">
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-5xl text-center">
        <MotionSection variant="fadeUp" className="space-y-8">
          {/* Main Heading */}
          <h2 className="text-3xl md:text-4xl lg:text-[42px] leading-[1.2] font-extrabold text-[#4B2A63] tracking-tight max-w-3xl mx-auto">
            {heading}
          </h2>
          ...
          <div className="space-y-6 max-w-3xl mx-auto">
            {bodyParagraphs.map((paragraph, index) => (
              <motion.p
                ...
                className="text-slate-600 text-base md:text-lg font-light leading-relaxed text-justify md:text-center"
              >
                {paragraph}
              </motion.p>
            ))}
